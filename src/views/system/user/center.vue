        ...
        <el-card class="box-card">
          ...
          <div>
            ...
            <ul class="user-info">
              ...
              <li><svg-icon icon-class="user1" /> 用户名 <div class="user-right">{{ user.nickName }}</div></li>
              <li><svg-icon icon-class="dept" /> 所属机构 <div class="user-right"> {{ user.dept.name }}</div></li>
            ...
            <el-tab-pane label="用户资料" name="first">
              <el-form ref="form" :model="form" :rules="rules" style="margin-top: 10px;" size="small" label-width="65px">
                <el-form-item label="用户名" prop="nickName">
                  ...
                  <span style="color: #C0C0C0;margin-left: 10px;">用户名不作为登录使用</span>
                </el-form-item>
