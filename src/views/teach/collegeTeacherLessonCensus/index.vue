...
<template>
  <div v-loading="loading" class="app-content">
    ...
    >
      ...
      <el-table-column prop="rightCount" label="到课次数" min-width="60" />
      <el-table-column prop="presentPercent" label="到课率" min-width="60" />
    </el-table>
    <el-pagination
      class="page_button"
      background
...
<script>
import api from "@/api/teach/collegeTeacherLessonCensus";
